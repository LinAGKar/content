...
> **Note:** The `xmlns` attribute is only required on the outermost `svg` element of _SVG documents_, or HTML documents with XML serialization. It is unnecessary for inner `svg` elements or inside HTML documents with HTML serialization.
